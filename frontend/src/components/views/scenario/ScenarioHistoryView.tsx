...
export const ScenarioHistoryView: React.FC = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className={`mt-1 ${theme === 'light' ? 'text-slate-600' : 'text-gray-400'}`}>
            View the execution history and results of your scenario
          </p>
        </div>
      </div>
      ...
      <Card className="p-12">
        <div className="text-center">
          <ClockIcon className={`w-16 h-16 mx-auto mb-4 ${theme === 'light' ? 'text-slate-400' : 'text-gray-400'}`} />
          ...
          <p className={`mb-6 ${theme === 'light' ? 'text-slate-500' : 'text-gray-400'}`}>
            This section will show the execution history for the scenario "{scenario.name}".
          </p>
...
export default ScenarioHistoryView; 