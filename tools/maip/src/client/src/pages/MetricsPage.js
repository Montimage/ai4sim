    ...
    const items = [
      {
        ...
        children: [
          {
            label: <a href="#performance">Model Performance</a>,
            key: 'performance',
          },
          {
            label: <a href="#confusion_matrix">Confusion Matrix</a>,
            key: 'confusion_matrix',
          },
          {
            label: <a href="#classification_plot">Classification Plot</a>,
            key: 'classification_plot',
          },
          {
            label: <a href="#precision_plot">Precision Plot</a>,
            key: 'precision_plot',
          },
          {
            label: <a href="#currentness">Currentness Metric</a>,
            key: 'currentness',
          },
        ],
      },
      {
        ...
        children: [
          {
            label: <a href="#impact">Impact Metric</a>,
            key: 'impact',
          },
        ],
      },
