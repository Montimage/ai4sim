...
const allowedOrigins = [
  ...
  'http://localhost:3001',
  'http://0.0.0.0:3001',
  'http://localhost:3000',  // AI4SIM Dashboard frontend
  'http://localhost:5173',  // Vite dev server default port
  'http://127.0.0.1:3000',
  'http://127.0.0.1:5173',
  '*' // Allow all origins for iframe embedding (temporary for debugging)
];

// Configure CORS with allowed origins - Allow all for iframe embedding
app.use(cors({
...
app.use(expressCspHeader({
  policies: {
      'default-src': [expressCspHeader.SELF, "'unsafe-inline'", "'unsafe-eval'"],
      'script-src': [expressCspHeader.SELF, "'unsafe-inline'", "'unsafe-eval'"],
      'style-src': [expressCspHeader.SELF, "'unsafe-inline'"],
      'img-src': [expressCspHeader.SELF, 'data:', 'blob:'],
      'font-src': [expressCspHeader.SELF],
      'connect-src': [expressCspHeader.SELF],
