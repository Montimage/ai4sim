...
For example, scanning the IP range of `192.168.1.176` can be done.

Multiple inputs within a single scan can be done via comma-separated input, as the following: `"target1.local,target2.local,target3.local,192.168.1.176,target4.local"`.
